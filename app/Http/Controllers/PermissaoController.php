...
class PermissaoController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('pages.permissoes.index')->with('success', 'Permissão atualizada com sucesso.');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('pages.permissoes.index')->with('success', 'Permissão excluída com sucesso.');
    }
}
