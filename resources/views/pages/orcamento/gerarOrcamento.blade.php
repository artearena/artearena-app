...
`;   
//fim---------------//---------------//---------------//---------------//---------------//---------------//---------------
        } else if(tipo.includes('Faixa de mão')) {
            titulo += `Faixa de mão - `;
//inicio---------------//---------------//---------------//---------------//---------------//---------------//---------------
descricao += `
**Tipo: ${tipo}** 
**Material:** Tactel / Bember / Oxford
**Tamanho:** ?
**Descrição:** ?

`;
//fim---------------//---------------//---------------//---------------//---------------//---------------//---------------
        } else if(tipo.includes('Wind banner')) {
            titulo += `Windbanner - `;
//inicio---------------//---------------//---------------//---------------//---------------//---------------//---------------
descricao += `
**Tipo: ${tipo}** 
...
//fim---------------//---------------//---------------//---------------//---------------//---------------//---------------
        ...
        if(tipo.includes('Chinelo Slide')) {
