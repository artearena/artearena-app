        ...
        @section('content')
                    ...
                    <tbody>
                        @foreach ($permissoes as $permissao)
                            <tr>
                                ...
                                <td>
                                    <!-- Botão Editar -->
                                <button class="btn btn-primary btn-editar" data-bs-toggle="modal" data-bs-target="#modalEditarPermissao{{ $permissao->id }}">
                                    Editar
                                </button>

                                <button class="btn btn-danger btn-excluir" data-bs-toggle="modal" data-bs-target="#modalConfirmarExclusao{{ $permissao->id }}">
                                    Excluir
                                </button>
            ...
            <div class="modal fade modal-editar-permissao" data-permissao-id="{{ $permissao->id }}" tabindex="-1" aria-labelledby="modalEditarPermissaoLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
