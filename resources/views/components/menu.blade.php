            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                @else
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="producaoDropdown">
                            <li><a class="dropdown-item" href="{{ route('pedido.etapaPedido') }}">Etapa do pedido</a></li>
            ...
            @else
                <div style="display: flex; align-items: center; margin-right: 20px;">
                    @if(auth()->user()->foto_perfil)
                        ...
                        <img src="{{ 'data:image/png;base64,'.$base64Image }}" alt="Foto de Perfil" style="width: 50px; height: 60px; border-radius: 25%; margin-right: 10px; object-fit: cover;">
                    @endif
                    <div>
