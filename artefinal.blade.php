...
<style>
    ...
    td[data-color="red"], td[data-color="orange"] {
        color: white;
    }
</style>
@endsection
                    ...
                    <table id="tabela-pedidos" class="table table-striped">
                        ...
                        <tbody>
                            ...
                            <tr data-id="{{ $pedido->id }}">
                                ...
                                <td contenteditable="true">{{ $pedido->id }}</td>
...
function reatribuirEventosChange() {
    ...
    $('#confirmMoverImpressaoButton').click(function() {
        ...
        // Salvar a referência à variável "this" para usar dentro da função "success"
        var $this = $(this);
        ...
        $("#tabela-pedidos").on("change", "select[name='dificuldade'], select[name='status'], select[name='checagem_final'], input[name='data']", function() {
            updateColors();
        });
